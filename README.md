...
## 本项目获取地址：https://www.bishecode.com/product/88/
...
图5.1 学生信息管理界面【大学生竞赛管理系统的系统管理员可以管理用户，可以对学生信息修改删除以及查询操作。具体界面的展示如图】
![alt text](images/image-4.png)

图5.2 教师信息管理界面【系统管理员可以查看对教师信息进行添加，修改，删除以及查询操作。具体界面如图】
![alt text](images/image-5.png)

图5.3 竞赛报名审核界面【教师可以对学生的竞赛报名进行审核操作。界面如下图所示】
![alt text](images/image-6.png)

图5.4 竞赛信息管理界面【教师可以对竞赛信息进行添加修改删除操作。界面如下图所示】
![alt text](images/image-7.png)

图5.5 竞赛信息界面【学生可以在竞赛信息管理里面进行报名操作。界面如下图所示】
